...
A site that uses and stores its own surplus pays far less for a flexible connection than the district average, and the planner, which empties the battery and moves charging into the limited hours, does most of it. Each district on the map links here.
